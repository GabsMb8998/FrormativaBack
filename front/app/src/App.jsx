...
useEffect(()=>{
  ...
  return(
    ...
    <div className={`duration-300 ease-in-out bg-[#242424] w-2/4 h-screen absolute ${login ? 'translate-x-full' : 'translate-x-0'} `}></div>
      ...
      {/* lado do login  */}
        <div className="bg-[#323232] w-2/4 h-screen flex justify-center items-center flex-col">
      ...
      {/* lado do cadastro */}
        <div  className="bg-[#323232] w-2/4 h-screen flex justify-center items-center">
