...
class TiposSensores(models.Model):
   tipo = models.CharField(max_length=50)

class DadosSensores(models.Model):

   tipo = models.ForeignKey (TiposSensores, on_delete=models.CASCADE)
...
class TemperaturaData(models.Model):
   sensor = models.ForeignKey(DadosSensores, on_delete=models.CASCADE)
