...
from app_smart.models import DadosSensores,TiposSensores, TemperaturaData, UmidadeData, LuminosidadeData, ContadorData
...
class SensorSerializer(serializers.ModelSerializer):
    tipo = serializers.PrimaryKeyRelatedField(queryset=TiposSensores.objects.all())
    class Meta:
        model = DadosSensores
        fields = '__all__'

class TiposSensoreSerializer(serializers.ModelSerializer):
    class Meta:
        model = TiposSensores
        fields = '__all__'
